                ...
                <x-dropdown>
                    ...
                    <a href="/admin/posts/create"
                       class="block text-left px-3 text-sm loading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white">New
                        Post</a>
                    <a href="/"
                       class="block text-left px-3 text-sm loading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white">
                        Home</a>
                </x-dropdown>


                <form method="POST" action="/logout" class="text-xs ml-6 font-semibold text-blue-500">
                    @csrf
